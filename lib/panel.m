                    ...
                    case 'f'
                        switch val
                            case 'a'
                                pars.fill = 1;      % all
                            case 'w'
                                pars.fill = 1;      % whole (legacy, not documented)
                            case 'tt'
                                pars.fill = 2 / 3;   % two thirds
                            case 'h'
                                pars.fill = 1 / 2;    % half
                            case 't'
                                pars.fill = 1 / 3;    % third
                            case 'q'
                                pars.fill = 1 / 4;    % quarter
                            otherwise
                    ...
                    case 'a'
                        switch val
                            case 's'
                                pars.fill = -1;         % square
                            case 'g'
                                pars.fill = -1.618;     % golden ratio (landscape)
                            case 'gp'
                                pars.fill = -1 / 1.618;  % golden ratio (portrait)
                            case 'h'
                                pars.fill = -2;         % half height
                            case 'd'
                                pars.fill = -0.5;       % double height
                            otherwise
                    ...
                    case 'r'
                        ...
                        switch val
                            ...
                            case 'h'
                                pars.dpi = 300;     % high
                            case 'p'
                                pars.dpi = 600;     % publication quality
                            case 'x'
                                pars.dpi = 1200;    % extremely high quality
                            otherwise
